...
function telephoneCheck(str) {
    ...
    let splyt = str.split("");
    console.log(splyt)
  let chqHasLetters = splyt.filter((i) => /[^0-9-()]/.test(i))
  chqHasLetters.length === 0 
  ? console.log(`no non-nums found in the current ( ${arguments[0]} ) argt`) 
  : console.log(`non-nums found in the current ( ${arguments[0]} ) argt are: ${chqHasLetters} `) 
  }
